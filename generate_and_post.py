...
POST_TYPES = [
    ...
    ("порівняння", "Коротко й зрозуміло порівняй варіанти в межах теми «{topic}»: що для чого краще підходить, щоб клієнт зміг обрати."),
]
...
TOPICS = [
    ...
    "який клей обрати: для газоблоку, плитки, гіпсокартону",
    "плиточний клей: як не помилитися з вибором",
    "цемент ПЦ-400 чи ПЦ-500: у чому різниця і що коли брати",
    "цементно-піщана суміш та коли потрібна готова суміш",
    "шпаклівка і штукатурка: чим відрізняються та послідовність робіт",
    "утеплення: мінвата чи пінопалст, звичайний чи екструдований",
    ...
    "фарба-емульсія чи емаль: що для чого",
